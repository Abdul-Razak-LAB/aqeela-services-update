...
const AllProducts = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="site-container flex flex-col items-start">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mt-12 pb-14 w-full">
